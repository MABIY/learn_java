 ...
 * Each class should hold a value, and at
 ...
 * operations on collections of your classes (these operations do not
 * have to be arithmeic as they are in Funcational.java)
 **/
...
public class E42_Functional2 {
    ...
    public static void main(String[] args) {
        ...
        print(
                Functional.transform(Functional.filter(ldm1, new Functional.GreaterThan<DataManipulator1>(rf)), new Incrementor())
        );
