...
public class Functional {
    // Calls the combine object on each element to combine
    ...
    // the list, ignoring the return value. The funcation
    // object may act as acollecting parameter, so it is
    // returned at the end
    ...
    //we can even make unaryFunction with an "ulp"
    // (units in the alst place):
    ...
    public static void main(String[] args) {
        ...
        print(rbi);
        // The sum fo this list of primes is also prime:
        print(rbi.isProbablePrime(5));

        List<AtomicLong> lai = Arrays.asList(
