...
public class Wildcards {
    ...
    static <T> T wildSubtype(Holder<? extends T> holder, T arg) {
        ...
        // Holder<Capture of ? extends T) in
    ...
    public static void main(String[] args) {
        ...
        // Unchekced conversion from Holder to HOlder<Long>
        ...
        // exact3(HOlder<T>,T) cannot be applied
        // to (Holder<capture of ? extend Long>,Long)
        ...
        // wildSupertype(Holder<? super T>,T) cannot b
