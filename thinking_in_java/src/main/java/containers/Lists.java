...
public class Lists {
    ...
    public static void basicTest(List<String> a) {
        ...
        // for ArrayLsit, expensive for LinkedList:
        s = a.get(1); // Get (typed) object of object
