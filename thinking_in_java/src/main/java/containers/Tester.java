...
/**
 * @author: liuHua
 * @create: 2019-01-20 15:32
 **/

public class Tester<C> {
	public static int fieldsWith = 8;
	...
	private void displayHeader() {
		...
		int width = fieldsWith * tests.size() + sizeWidth;
	...
	public void timedTest() {
		...
		for (TestParam param : paramList) {
			...
			for (Test<C> test : tests) {
				...
				long timPerRep = duration / reps; // Nanoseconds
				System.out.format(numberField(), timPerRep);
			}
			System.out.println();
		}
	}
