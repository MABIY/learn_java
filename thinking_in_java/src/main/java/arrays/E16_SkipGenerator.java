...
/**
 * @author lh
 * Staring with CountingGenerator.java. Create a
 * SkipGenerator class that produces new vallues by
 * incrementing according to a construcotr argument.
...
public class E16_SkipGenerator {
    public static void main(String[] args) {
        ...
        long[] a6 = ConvertTo.primitive(Generated.array(
                Long.class, new SkipGenerator.Long(5), 6
        ));
