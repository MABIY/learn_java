...
public class E17_Sets2 {
    public static void main(String[] args) {
        ...
        System.out.println("union(set1,set2) type: " + Sets2.union(set1, set2).getClass().getSimpleName());
        ...
        System.out.println("union(set3,set4set3,set4set3,set4set3,set4set3,set4set3,set4set3,set4set3,set4set3,set4) type: " + Sets2.union(set3, set4).getClass().getSimpleName());
    }
}
