...
class House {
    ...
    public synchronized void purConcreteSlab() {
        concreteSlab = true;
    }
...
class FootingDigger implements Runnable {
    private HouseQueue houseQueue;
    private int counter = 0;

    public FootingDigger(HouseQueue houseQueue) {
    ...
    public void run() {
        try {
            ...
            print("Interrupted: FootingsDeigger");
        }
...
class Reporter22 implements Runnable {
    private HouseQueue houseQueue;

    public Reporter22(HouseQueue houseQueue) {
        this.houseQueue = houseQueue;
    }
...
public class E38_HouseBuilder{
    public static void main(String[] args) throws InterruptedException {
        ...
        exec.execute(new HouseBuilder(footingQueue, finishingQueue, teamPool));
        exec.execute(new Reporter22(finishingQueue));
        exec.execute(new FootingDigger(footingQueue));
